## This is code for plotting plot3 in png format
...
# Draw line plot for Sub metering 1 and then annotate with Sub metering 2 &3 and legend
...
## Required plot is plotted in the png file in working directory
